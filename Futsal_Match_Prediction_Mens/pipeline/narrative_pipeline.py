...
"""
        if has_player:
            base += """Return a valid JSON object with EXACTLY the following three keys:
{
...
"""
            ...
            base += """Return a valid JSON object with EXACTLY the following two keys:
{
  "matchSummary": "<2-3 sentences>",
  "overallAssessment": "<1-2 sentences>"
}
...
"""
        if best_player != "N/A":
            prompt += """3. Why the key player stands out — consider form, trend, and head-to-head history.
4. Whether the player consistently performs against this opponent or had a one-off.
"""
            
        prompt += """5. Any notable historical matchup patterns.
        ...
        for attempt in range(max_attempts):
            try:
                ...
                if attempt < max_attempts - 1:
                    print("[CommentaryGenerator] Rate limit hit. Waiting 35 seconds before retrying...")
